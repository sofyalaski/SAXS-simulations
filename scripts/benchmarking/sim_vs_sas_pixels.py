...
def compare_hardspheres():
    ...
    plt.savefig('../results/hardspheres_5nm_comp.png', format = 'png')
...
def compare_spheres():
    ...
    plt.legend(title = 'Simulation' )
    plt.savefig('../results/spheres_5nm_comp.png', format = 'png')
...
def compare_cylinders():
    ...
    plt.savefig('../resylts/cylinders_5nm_25_nm_comp.png', format = 'png')
